...
<div class="home">
    ...
    <form action="createPost.php" method="POST" enctype="multipart/form-data">
        <div class="post-text">
            <img src="images/user.jpg" alt="user">
            <textarea name="postContent" placeholder="What's on your mind, zahidul" required></textarea>
        </div>

        <div class="post-icon">
            <label for="fileUpload" style="background: #ffebed;">
                <i style="background: #ff4154;" class="fa-solid fa-camera"></i>
                Gallery
            </label>
            <input type="file" id="fileUpload" name="postImage" accept="image/*" style="display:none;">
            ...
            <!-- Submit Button -->
            <button type="submit" style="background: #0053ff; color: #fff; border: none; padding: 10px 20px; border-radius: 5px;">
                Post
            </button>
        </div>
    </form>
